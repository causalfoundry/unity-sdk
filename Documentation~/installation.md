...
```text
https://github.com/causalfoundry/unity-sdk.git#v1.0.7
```
...
{
  "dependencies": {
    "io.kenkai.upm.sdk": "https://github.com/causalfoundry/unity-sdk.git#v1.0.7"
  }
}
```

Replace `v1.0.7` with the required published version. Pin a release tag or full commit SHA for
